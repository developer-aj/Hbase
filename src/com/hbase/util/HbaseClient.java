...
public class HbaseClient {
	public static void main(String[] args) throws IOException {
		...
		config.set("hbase.zookeeper.quorum", "server’s IP address");
		...
		try {
			...
			try {
				...
				// cell you'd
				// like to update. The column family must already exist in your
				// table
				// schema. The qualifier can be anything. All must be specified
				// as byte
				// arrays as hbase is all about byte arrays. Lets pretend the
				// table
				// 'myLittleHBaseTable' was created with a family
				// 'myLittleFamily'.
				p.add(Bytes.toBytes("personal"), Bytes.toBytes("name"), Bytes.toBytes("Jack"));
				...
				byte[] value = r.getValue(Bytes.toBytes("personal"), Bytes.toBytes("name"));
				...
				try {
					...
					// Now, for the actual iteration. One way is to use a while
					// loop like so:
